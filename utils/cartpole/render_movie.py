...
def save_mp4(data, n, video_prefix=""):
    ...
    print(os.system("ffmpeg -y -framerate 25 -i "+video_prefix+"_imgs/_tmp%03d.png  -c:v libx264 -pix_fmt yuv420p "+video_prefix+"_video/_out" + str(n) + ".mp4 > /dev/null 2> /dev/null"))
